...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_log_entries_conversation_id'), 'log_entries', ['conversation_id'], unique=False)
    op.create_index('ix_log_entries_user_conversation', 'log_entries', ['user_id', 'conversation_id'], unique=False)
    op.create_index('ix_log_entries_user_created', 'log_entries', ['user_id', 'created_at'], unique=False)
